...
#define ERROR_CODE_APPS2_LOW 0x00000010UL
#define ERROR_CODE_APPS2_HIGH 0x00000020UL
#define ERROR_CODE_APPS_DIVERGE 0x00000040UL
#define ERROR_CODE_BSE_LOW 0x00000080UL
#define ERROR_CODE_BSE_HIGH 0x00000100UL
#define ERROR_CODE_PEDAL_IMPLAUSIBILITY 0x00000200UL

// TODO: remove this
#define ERROR_CODE_APPS_IMPLAUSIBILITY 0x00000400UL
#define ERROR_CODE_BSE_IMPLAUSIBILITY 0x00000800UL

#define ERROR_CODE_ADC 0x00001000UL
#define ERROR_CODE_SPI 0x00002000UL
#define ERROR_CODE_I2C 0x00004000UL
...
#define IS_ERROR_CODE(CODE)                                                \
  ((CODE) & (ERROR_CODE_CAN_TX | ERROR_CODE_CAN_RX_CRITICAL |              \
             ERROR_CODE_CAN_RX_OPTIONAL | ERROR_CODE_APPS_IMPLAUSIBILITY | \
             ERROR_CODE_BSE_IMPLAUSIBILITY | ERROR_CODE_PEDAL_IMPLAUSIBILITY))
