...
#define ERROR_CODE_APPS_IMPLAUSIBILITY 0x00000010UL
#define ERROR_CODE_BSE_IMPLAUSIBILITY 0x00000020UL
#define ERROR_CODE_PEDAL_IMPLAUSIBILITY 0x00000040UL
